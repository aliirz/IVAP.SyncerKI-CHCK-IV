...
namespace IVAP.Syncer
{
    public class SyncedVC
    {
        ...
        public string verified_by_a { get; set; }
        public string verified_by_b { get; set; }
        public string verified_by_c { get; set; }
        public string verified_by_d { get; set; }
        public string verified_by_e { get; set; }
        public string verified_by_f { get; set; }
        public string verified_by_g { get; set; }
        ...
        public string doc_type_a { get; set; }
        public string doc_type_b { get; set; }
        public string doc_type_c { get; set; }
        public string doc_type_d { get; set; }
        public string doc_type_e { get; set; }
        public string doc_type_f { get; set; }
